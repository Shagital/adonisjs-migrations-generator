  ...
  ally: {
    ...
    */
    facebook: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/facebook/callback`
    },
    ...
    */
    google: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/google/callback`
    },
    ...
    */
    github: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/github/callback`
    },
    ...
    instagram: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/instagram/callback`
    },
    ...
    foursquare: {
      ...
      redirectUri: `${Env.get('APP_URL')}/api/foursquare/callback`
    },
    twitter: {
      clientId: Env.get('TWITTER_API_KEY'),
      clientSecret: Env.get('TWITTER_API_SECRET'),
      redirectUri: `${Env.get('APP_URL')}/api/twitter/callback`
    }
  }
}
