...
## Delete a feedbacktemplate with id.


DELETE feedbacktemplates/:id

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/feedback_templates/47964"
);
...
## Show a list of all feedbackusers.
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/feedback_users"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/feedback_users" 
...
## Display a single feedbackuser.


GET feedback_users/:id

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/feedback_users/46298"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/feedback_users/46298" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quizzes"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quizzes" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quizzes/5376"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quizzes/5376" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quizzes/92045"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quizzes/3974"
);
...
## Show a list of all quizanswers.
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_answers"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quiz_answers" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_answers/74271"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quiz_answers/74271" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/question_options"
);
...
### Request
<small class="badge badge-black">POST</small>
 **`/api/question_options`**


## Update quizoption details.


PUT or PATCH quiz_options/:id

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/question_options/82203"
);
...
## Delete a quizoption with id.


DELETE quiz_options/:id

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/question_options/55830"
);
...
## Show a list of all quizquestions.
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quizzes/13032/questions"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quizzes/13032/questions" 
...
## Show a list of all questionoptions.


GET quiz_questions/:id/options

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_questions/72062/options"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quiz_questions/72062/options" 
...
## Create/save a new quizquestion.
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_questions"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_questions/42960"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/quiz_questions/42960" 
...
## Update quizquestion details.


PUT or PATCH quiz_questions/:id

> Example request:

```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_questions/68023"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/quiz_questions/90917"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/et/dolor/embed.js"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/v1/et/dolor/embed.js" 
...
### Request
<small class="badge badge-green">GET</small>
 **`/api/v1/:accountKey/:widgetId/embed.js`**

<h4 class="fancy-heading-panel"><b>URL Parameters</b></h4>
<b><code>accountKey</code></b>&nbsp;  
<br>


<b><code>widgetId</code></b>&nbsp;  
<br>



## Create/save a new feedback input.
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/consequatur/aut/submit"
);
...
### Request
<small class="badge badge-black">POST</small>
 **`/api/v1/:accountKey/:widgetId/submit`**
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/admin/coupons"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/v1/admin/coupons" 
...
```json
{"message":"E_MISSING_NAMED_MIDDLEWARE: Cannot find any named middleware for {admin}. Make sure you have registered it inside start/kernel.js file.\n> More details: https://err.sh/adonisjs/errors/E_MISSING_NAMED_MIDDLEWARE","stack":"RuntimeException: E_MISSING_NAMED_MIDDLEWARE: Cannot find any named middleware for {admin}. Make sure you have registered it inside start/kernel.js file.\n> More details: https://err.sh/adonisjs/errors/E_MISSING_NAMED_MIDDLEWARE\n    at Function.invoke (/Users/djunehor/Sites/feedback/node_modules/@adonisjs/generic-exceptions/src/RuntimeException.js:102:12)\n    at /Users/djunehor/Sites/feedback/node_modules/@adonisjs/middleware-base/index.js:225:35\n    at Array.map (<anonymous>)\n    at MiddlewareBase._compileNamedMiddleware (/Users/djunehor/Sites/feedback/node_modules/@adonisjs/middleware-base/index.js:211:28)\n    at MiddlewareBase.composeGlobalAndNamed (/Users/djunehor/Sites/feedback/node_modules/@adonisjs/middleware-base/index.js:345:60)\n    at Server._executeRouteHandler (/Users/djunehor/Sites/feedback/node_modules/@adonisjs/framework/src/Server/index.js:99:8)\n    at /Users/djunehor/Sites/feedback/node_modules/@adonisjs/framework/src/Server/index.js:430:21"}
```
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/admin/coupons/29233"
);
...
```bash
curl -X GET \
    -G "http://127.0.0.1:3333/api/v1/admin/coupons/29233" 
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/admin/coupons/19372"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/v1/admin/coupons/37407"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/sunt/license/register"
);
...
```javascript
const url = new URL(
    "http://127.0.0.1:3333/api/modi/license/validate"
);
